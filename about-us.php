                  ...
                  <?php endif; ?>
                    <div class="col-12 col-sm-7 offset-md-1">
                        ...
                        <p class="text-justify">
                            <strong><?php pl_e( 'Yes Soft' ); ?></strong> <?php pl_e( ' is an e-commerce specialized software company located in Berlin/ Germany. It adopts an open-source methodology. All its projects\' codes are available on' ); ?>  <a href="https://github.com/yes-soft-de/"><?php pl_e( 'Github' ); ?></a>.<br>
                            <?php pl_e( 'Its team consists of developers, designers, content makers, testers, and team managers. They work together remotely, and the results are always great.' ); ?>
                            <?php pl_e( 'They use up-to-date technologies to bring your imaginary requirements to reality.' ); ?><br>
                            <?php pl_e( 'Do you still hesitate about the company? Why don\'t you check out' ); ?> <a href="http://ishtar-art.de/"><?php pl_e( 'ISHTAR ART' );?></a><?php pl_e(' to evaluate everything by yourself?') ?>
                        </p>
                    </div>
	                <?php if ( !$detect->isMobile() ): ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-7 pt-5 mx-auto mx-md-0">
                        <p class="text-justify">
                            <strong><?php pl_e( 'E-Commerce' ); ?></strong><?php pl_e( ' means buying and selling of goods, products, or services over the Internet. These services provided online over the internet network. Transaction of money, funds, and data are considering as E-commerce. 
                            ...
                            <?php pl_e( 'Here we go.' ); ?><br/>
	                        <?php pl_e( 'At' ); ?> <strong><?php pl_e( 'Yes Soft' ); ?></strong>, <?php pl_e( 'we introduce a variety of ways to build eCommerce websites and apps. From using customizable platforms like Wordpress and' ); ?> <a href="https://www.prestashop.com/en"><?php pl_e( 'Prestashop' ); ?></a> <?php pl_e( 'to building a brand new website from zero as we did at our project' ); ?> <a href="http://ishtar-art.de/"><?php pl_e( 'ISHTAR' ); ?></a>.
                            <span>
                                <?php pl_e( 'Is this all that we introduce?' ); ?><br/>
                                <?php pl_e( 'No, of course. We also develop Android apps for the same target, professional Ecommerce platforms.' ); ?>
                            </span>
                            <span>
                                <?php pl_e( 'Does our work about Ecommerce only?' ); ?><br/>
                                <?php pl_e( 'No, we also develop websites and apps for any work discipline. But, our expertise is Ecommerce related projects.' ); ?>
                            </span>
                        </p>
                    </div>
                </div>
...
<!--                            <img src="--><?php //echo get_template_directory_uri() . '/img/aboutus-remote-maintenance.png'; ?><!--" class="img-fluid" alt="laptop Image">-->
                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-7 pt-5 mx-auto mx-md-0">
                        <p class="text-justify">
	                        <?php pl_e( 'The vital third side to tell you about to complete Our base triangle is:' ); ?> <strong><?php pl_e( 'Remote Maintenance' ); ?></strong>.
                            <br/><br/>
                            <strong><?php pl_e( 'Remote Maintenance' ); ?></strong> <?php pl_e( 'is a service we offer to companies and individuals to tell them what\'s wrong with their websites, suggest solutions, and apply them if they order.' ); ?>
                            <br/><br/>
	                        <?php pl_e( 'We take care of plenty of problems related to Browser compatibility problems, Responsive issues, Not working links and forms, Not removed indexing codes, Slow sites problem, and more.' ); ?>
                            <br/><br/>
	                        <?php pl_e( 'Our fully-remotely working team can handle all that and more. We can hire one person or our full team capacity to help you.' ); ?>
                            <br/><br/>
	                        <?php pl_e( 'After all that you read about us, are you still hesitant to try our services? We promise you won\'t regret it.' ); ?>
                        </p>
                    </div>
                </div>
            </div>
