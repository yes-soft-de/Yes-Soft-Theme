...
<div class="about-us-separate-page">
<!--	<div class="container">-->
				...
				<div class="row">
					...
					<div class="col-12 col-sm-7 offset-md-1">
						...
						<p class="text-justify">
							...
							They use up-to-date technologies to bring your imaginary requirements to reality.<br>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-10 col-md-8 col-lg-7 pt-5 mx-auto mx-md-0">
						<p class="text-justify">
							...
							Here we go.<br/>
							At <strong>Yes Soft</strong>, we introduce a variety of ways to build Ecommerce websites and apps. From using customizable platforms like wordpress and <a href="https://www.prestashop.com/en">Prestashop</a> to building a brand new website from zero like we did at our project <a href="http://ishtar-art.de/">ISHTAR</a>.
							<span>
								Is this all what we introduce?<br/>
								No, of course. We also develop Android apps for the same target, professional Ecommerce platforms.
							</span>
							<span>
								Do our work about Ecommerce only?<br/>
								No, we also develop websites and apps for any work discipline. But, our expertise is Ecommerce related projects.
							</span>
						</p>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-10 col-md-7 col-xl-8 offset-sm-1 pt-5">
						<p class="text-justify">
							...
							<br/><br/>
							As <strong>Yes Soft</strong> has an online-working team, it has many things in common with all electronic activities such as Ecommerce we talked about before. <strong>E-marketing</strong> lays in the same perspective for us. It’s an active discipline in today’s world. And it completes our working strategy, marketing projects we developed.
							<br/>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-10 col-md-8 col-lg-7 pt-5 mx-auto mx-md-0">
						<p class="text-justify">
							...
							<br/><br/>
							<strong>Remote maintenance</strong> is a service we offer to companies and individuals in order to tell them what's wrong with their websites, suggest solutions and apply them if they order.
							<br/><br/>
