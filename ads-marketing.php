						...
						<div class="col-md-6 col-12">
							<ul>
								<li>
									...
									Great marketing campaigns to quickly reach customers and promote in the right way.
								</li>
								<li>
									<i class="fas fa-angle-double-right"></i>
								...
								<li>
									<i class="fas fa-angle-double-right"></i>
									Study the marketing process and study the market to attract customers correctly and achieve the expected results.
								</li>
							</ul>
						</div>
						<div class="col-md-6 col-12">
							<img src="<?php echo get_template_directory_uri() . '/img/yes-ads-img/marketing.gif'; ?>" class="img-fluid">
						</div>
					</div>
				</div>
