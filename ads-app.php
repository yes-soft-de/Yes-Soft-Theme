					...
					<div class="row">
						<div class="col-md-6 col-12">
							<div class="perspective-phone">
								<img src="<?php echo get_template_directory_uri() . '/img/yes-ads-img/phone.png'; ?>" alt="phone image" class="img-fluid">
								<img src="<?php echo get_template_directory_uri() . '/img/yes-ads-img/phone.png'; ?>" alt="phone image" class="img-fluid">
								<img src="<?php echo get_template_directory_uri() . '/img/yes-ads-img/phone.png'; ?>" alt="phone image" class="img-fluid">
							</div>
						</div>
						<div class="col-md-6 col-12">
							<ul class="features">
								<li>
									...
									Contemporary, elegant and eye-catching design.
								</li>
								<li>
									<i class="fas fa-angle-double-right"></i>
									The application works on all systems Android & IOS.
								</li>
								<li>
									<i class="fas fa-angle-double-right"></i>
									Comfortable and thoughtful user experience to ensure ease of use.
								</li>
								<li>
									<i class="fas fa-angle-double-right"></i>
									Various features covering all requirements
								</li>
							</ul>
						</div>
					</div>
