<?php /* Template Name: fullPackageService */ ?>
<?php get_header() ?>
...
<div class="our-posts e-commerce-service our-services py-5" xmlns="http://www.w3.org/1999/html">
    <div class="container">
        <div class="post p-3 pb-0 bg-white mb-5">
            ...
            <h1 class="col-12 col-sm-9 col-lg-7 col-xl-6 mx-auto text-center pt-5">Full Package Service</h1>
            <hr class="my-3">
            <p class="general-desc mb-5">
                You are in the right place, here is the best offer you can ever get in your business journey.<br />
                Our experts have combined Social Media Marketing with Social Engine Marketing, to make a full package of marketing services where you can simply be the best in your business field.<br />
                Our teams of Developers, along with our Designers, Digital Marketing and SEO Specialists will make sure that you can SkyRocket your business, increase your sales dramatically, and ranks in first google search results with the best methods of monitoring and measuring performance.<br />
                Our Services include:<br />
                1-	Paid Social Media Advertisement (CPI – CPC)<br />
                2-	Organic Social Media Advertisement<br />
                3-	Paid Search Engine Advertisement (SEA)<br />
                4-	Search Engine Optimization (SEO)<br />
                <br />
                ...
                This full package is the best chance for you to lift your business into a whole new level with the help of experts and specialists from different teams who combined their skills to make you the best.<br />
                You're worth it, so don't delay in starting your business journey with Yes-Soft.<br />
            </p>
