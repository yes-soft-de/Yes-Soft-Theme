<?php /* Template Name: ishtarService */ ?>
<?php get_header() ?>
...
<div class="our-posts e-commerce-service our-services py-5">
    <div class="container">
        <div class="post p-3 pb-0 bg-white mb-5">
            ...
            <h1 class="col-12 col-sm-9 col-lg-7 col-xl-6 mx-auto text-center pt-5">Ishtar Service</h1>
            <hr class="my-3">
            <p class="general-desc mb-5">
                Get rid of your fears and unleash your creativity with Yes-Soft, since our job is to understand your imagination and make it real.<br />
                In fact, we are one of the first companies that provide artist e-commerce stores, and above that, we are the leading company in this field.<br />
                If you want to develop a long-term professional e-commerce Art site, you should always think of Yes-Soft solutions and services, since our reputation goes with it.<br />
            </p>
            <table class="table">
...
<!--            </div>-->
        ...
        <div class="col-12">
            <p class="text-justify mb-5">
                So, how can we help you to achieve your artistic inspirations?<br />
                We provide high-quality artistic e-commerce services, where you can SkyRocket your online sales and feel the quality with reasonable prices and flexibility for customizing or adding features based on your requirements.<br />
                ...
                Our services are based on Ishtar platform, which is a great art selling platform developed by expert programmers to fit your needs and expectations.<br />
                ...
                Our team of Developers, along with our Designers, Digital Marketing and SEO Specialists will make sure that your e-commerce platform looks simply awesome and ranks in google search results with the best methods of monitoring and measuring performance.<br />
                With our 3 flexible plans (Basic - Advanced - Premium) we ensure that we can fit your business needs at no extra cost, giving you only the services needed to make your artistic e-commerce platform a magnet for clients and looks smooth.<br />
                You're Worth It and always remember that we have a lot of nice offers beyond our plans.<br />
                To feel comfortable with your choice, you can take a look at one of our projects in artistic e-commerce platforms <a href="http://ishtar-art.de/">Ishtar</a>.<br />
            </p>
        </div>
