<?php /* Template Name: flayerDesign */ ?>
<?php get_header() ?>

    <div class="our-posts flayer-design e-commerce-service our-services py-5">
        <div class="container">
            <h1 class="col-12 col-sm-9 col-lg-7 col-xl-6 mx-auto text-center">Flayer Design</h1>
            <div class="post p-3 pb-4 bg-white mb-5">
                <hr class="mb-3 mt-1">
                <p class="general-desc mb-5">
                    flayer is the first impression a potential client may take.
                    For this reason, you want this impression to be excellent. We offer these categories in this field:
                </p>
                <div class="project">
                    ...
                    <div class="info">
                        <div class="basic">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 text-center mb-1">
                                    <strong>Cost: 25$</strong>
                                </div>
                                <div class="col-12 mt-3 mb-1"><p class="mb-0">1 initial concept included</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Source file</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Logo transparency</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">High resolution</p></div>
                        ...
                        <div class="standard">
                            <p>
                                Flayer & business card. Print ready. Double-sided. Commercial use.
                            </p>
                            <div class="row">
                                <div class="col-5 mb-1">
                                    <strong>Delivery time: 3 Days </strong>
                        ...
                        <div class="premium">
                            <p>
                                Flayer & business card. Logo & social media. Print ready.
                            </p>
                            <div class="row">
                                <div class="col-5 mb-1">
                                ...
                                <div class="col-3 text-center mb-1">
                                    <strong>Cost: 200$</strong>
                                </div>
                                <div class="col-12 mt-3 mb-1"><p class="mb-0">1 initial concept included</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Source file</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Logo transparency</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">High resolution</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Stationary designs</p></div>
                                <div class="col-12 mb-1"><p class="mb-0">Social media kit </p></div>
                                <div class="col-12 d-none text-center mt-5">
