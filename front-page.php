...
<div class="home" id="home">
    <div class="container">
        <div class="row">
            <!--First Section-->
            <div class="col-md-6">
                <h1 class="text-center">COLOURED BUSINESS TEMPLATE</h1>
           ...
           <div class="col-9 service-carousal">
               <div class="card">
                   ...
                   <div class="card-body">
                       ...
                       <p class="card-text">
                           Can Build Your Website With Wordpress
                       </p>                       
                   </div>
               </div>
               <div class="card">
...
<div class="our-teammate" id="our-teammate">
    <div class="container">
        ...
        <p>
            We believe that teamwork makes the dream work, So here’s the team behind our fabulous work and products.
        </p>
        <hr class="w-25">
